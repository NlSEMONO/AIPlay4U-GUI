import { blockTypes } from "./components/Constants";
import { useState } from 'react'
import { Block, PositionedBlock, SidebarParams } from "./components/Definitions";
import './App.css'
...
//   the drawing area.
function Sidebar({blocks, blockSetter} : SidebarParams) {
